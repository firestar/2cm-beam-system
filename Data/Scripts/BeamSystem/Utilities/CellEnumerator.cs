/*
 * Script from MA Laser Beam System 
...
namespace BeamSystem
{
    struct CellEnumerator
    {
        ...
        public static CellEnumerator EnumerateGridCells(IMyCubeGrid grid, Vector3D worldStart, Vector3D worldEnd) //, Vector3I? gridSizeInflate = null)
        {
